...
use EscaliersSolution\LaravelAdmin\Console\CreateUserCommand;
use EscaliersSolution\LaravelAdmin\Console\CreatePermissionCommand;
use EscaliersSolution\LaravelAdmin\Console\CreateApiCommand;
use EscaliersSolution\LaravelAdmin\Console\MakeModuleCommand;
use EscaliersSolution\LaravelAdmin\Console\ExtendedModelMakeCommand;
use EscaliersSolution\LaravelAdmin\Console\ExtendedControllerMakeCommand;
use EscaliersSolution\LaravelAdmin\Console\ExtendedPolicyMakeCommand;
use EscaliersSolution\LaravelAdmin\Console\LaravelAdminInstallCommand;
use EscaliersSolution\LaravelAdmin\Console\FactoryResetCommand;
use EscaliersSolution\LaravelAdmin\Console\SeedSpamCommand;

use EscaliersSolution\LaravelAdmin\Http\Middlewares\AuthenticateAdmin;
