            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="alert alert-warning" role="alert">
                        ...
                        <p>This area is meant for Advanced users only. Do not execute these commands unless you know what you are doing.<br/>Misuse may result in disruption of service and even <strong>permanent</strong> loss of data.</p>
                                    ...
                                    @foreach ($commands as $command)
                                        <div class="command" data-command="{{ $command->name }}">
                                            ...
                                            <form action="{{ $url }}" class="cmd_form" method="POST">
                                                ...
                                                <input type="submit" class="btn btn-dark pull-right run-command"
                                                       value="Run Command">
                                                <input type="hidden" name="command" id="hidden_cmd"
                                                       value="{{ $command->name }}">
                                            </form>
                                        </div>
                                    @endforeach
